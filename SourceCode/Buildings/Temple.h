...
UCLASS()
class MYPROJECT2_API ATemple : public AActor, public ISelectable, public Ibuilding
{
	GENERATED_BODY()
...
public:
	...
	//Updates the state of a building (called on repairs)
	...
	virtual int getID_Implementation() override { return (status >= 100) ? templeID : 0; };
